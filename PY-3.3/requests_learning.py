...
# функция, которая собственно и переводит файл, а затем сохраняет результат в другом файле
def translate_it(text_file, target_file, from_lang, to_lang='ru'):
    ...
    with open(text_file, 'r', encoding='utf_8') as translate_file:
        ...
        for line in translate_file:
            ...
            text.append(' '.join(json_data['text']))
...
print('Ищите переведенные файлв в директории запуска программы!')